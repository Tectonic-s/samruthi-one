  ...
  return (
    <div className="py-12 lg:py-20 relative z-10">
      <div className="w-full mx-auto px-4 lg:px-6">
        ...
        {/* Header Section */}
        <div className="bg-gray-950/30 backdrop-blur-xl p-8 sm:p-12 rounded-[2rem] border border-white/15 shadow-2xl mb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 bg-gray-950/30 backdrop-blur-xl p-8 rounded-[2rem] border border-white/15 shadow-xl flex flex-col items-center justify-center min-h-[300px] text-center relative overflow-hidden group hover:border-[#F7C83C]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out">
          ...
          <div className="lg:col-span-8 space-y-10">
            {/* Context Paragraphs */}
            <div className="bg-gray-950/30 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] border border-white/15 shadow-xl space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {values.map((v) => (
                  <div key={v.title} className="bg-gray-950/30 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] border border-white/15 shadow-lg relative group hover:border-[#F7C83C]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out">
            ...
            <div>
              ...
              <div className="space-y-4">
                {team.map((m) => (
                  <div 
                    key={m.name} 
                    className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-950/30 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] border border-white/15 shadow-lg hover:border-[#F7C83C]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out"
                  >
