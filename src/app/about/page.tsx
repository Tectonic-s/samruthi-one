  ...
  return (
    <div className="py-12 lg:py-20 relative z-10">
      <div className="w-full mx-auto px-4 lg:px-6">
        ...
        {/* Header Section */}
        <div className="bg-gray-950/80 backdrop-blur-xl p-8 sm:p-12 rounded-[2rem] border border-white/10 shadow-2xl mb-12">
          <p className="text-xs font-semibold tracking-widest uppercase text-[#FFC800] mb-3">About Us</p>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white tracking-tight">
            Built on <span className="text-[#FFC800]">Trust</span>, Driven by Results
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 bg-gray-950/80 backdrop-blur-xl p-8 rounded-[2rem] border border-white/10 shadow-xl flex flex-col items-center justify-center min-h-[300px] text-center relative overflow-hidden group hover:border-[#FFC800]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out">
            <span className="text-8xl font-black text-[#FFC800]/5 absolute select-none pointer-events-none group-hover:text-[#FFC800]/10 transition-colors duration-300">
              S1
            </span>
          ...
          <div className="lg:col-span-8 space-y-10">
            {/* Context Paragraphs */}
            <div className="bg-gray-950/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] border border-white/10 shadow-xl space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {values.map((v) => (
                  <div key={v.title} className="bg-gray-950/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] border border-white/10 shadow-lg relative group hover:border-[#FFC800]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out">
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1.5 h-10 bg-[#FFC800] rounded-r-md group-hover:h-12 transition-all duration-300" />
            ...
            <div>
              ...
              <div className="space-y-4">
                {team.map((m) => (
                  <div 
                    key={m.name} 
                    className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-950/80 backdrop-blur-xl p-6 sm:p-8 rounded-[2rem] border border-white/10 shadow-lg hover:border-[#FFC800]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out"
                  >
                    <div className="w-12 h-12 rounded-full bg-[#FFC800] text-gray-900 font-extrabold flex items-center justify-center text-sm shadow-md flex-shrink-0">
                      {m.initials}
                    </div>
                    <div>
                      <h4 className="text-base font-bold text-white">{m.name}</h4>
                      <p className="text-xs font-semibold text-[#FFC800] mt-0.5">{m.role}</p>
