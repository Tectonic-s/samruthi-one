      ...
      <section className="py-16 lg:py-24 relative z-10">
        <div className="w-full mx-auto px-4 lg:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-10 gap-4">
            ...
            <Link href="/services" className="self-start sm:self-auto border border-[#F7C83C]/40 text-[#F7C83C] px-5 py-2 text-sm hover:border-[#F7C83C] hover:shadow-[0_0_16px_0_rgba(255,200,0,0.15)] transition-all duration-500 ease-out whitespace-nowrap rounded-xl">
              View All Services
            </Link>
          </div>
