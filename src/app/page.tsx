  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 bg-gray-950/30 backdrop-blur-xl p-8 sm:p-12 rounded-[2rem] border border-white/15 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/enquiry" className="inline-block bg-[#F7C83C] text-gray-900 font-bold px-8 py-4 text-sm tracking-wide hover:bg-[#D4A832] hover:shadow-[0_0_24px_2px_rgba(255,200,0,0.25)] hover:-translate-y-1 transition-all duration-500 ease-out text-center shadow-lg rounded-xl">
                  Get Started
                </Link>
                <Link href="/services" className="inline-flex items-center justify-center border border-white/30 text-white px-8 py-4 text-sm hover:border-[#F7C83C]/60 hover:shadow-[0_0_24px_2px_rgba(255,200,0,0.13)] hover:-translate-y-1 transition-all duration-500 ease-out shadow-lg rounded-xl">
                  Our Services &rarr;
                </Link>
              </div>
            ...
            <div className="lg:col-span-5 hidden md:grid grid-cols-2 gap-4 lg:gap-6 lg:pl-6">
              {SITE_CONFIG.stats.map((stat) => (
                <div key={stat.label} className="bg-gray-950/30 backdrop-blur-xl p-8 rounded-[2rem] border border-white/15 shadow-xl flex flex-col justify-center min-h-[160px] hover:border-[#F7C83C]/60 hover:shadow-[0_0_32px_2px_rgba(255,200,0,0.13)] hover:-translate-y-2 transition-all duration-500 ease-out">
      ...
      <section className="py-16 lg:py-24 relative z-10">
        <div className="w-full mx-auto px-4 lg:px-6">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-10 gap-4">
            ...
            <Link href="/services" className="self-start sm:self-auto bg-gray-950/30 backdrop-blur-xl border border-white/15 rounded-xl px-6 py-3 text-xs font-semibold tracking-widest uppercase text-[#F7C83C] whitespace-nowrap shadow-xl hover:border-[#F7C83C]/40 transition-all">
              View All Services
            </Link>
          </div>
      ...
      <section className="py-16 relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1400px] mx-auto text-center bg-gray-900/25 backdrop-blur-xl border border-white/15 rounded-[2rem] p-8 sm:p-12 shadow-2xl">
          ...
          <Link href="/enquiry" className="inline-block bg-[#F7C83C] text-gray-900 font-bold px-10 py-4 text-sm tracking-widest uppercase hover:bg-[#D4A832] transition-colors rounded-xl shadow-lg">
            Submit Enquiry
          </Link>
        </div>
      </section>
