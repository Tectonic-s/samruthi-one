...
export default function Footer() {
  return (
    <footer className="bg-gray-950/90 border-t border-white/10 text-gray-400 py-16 mt-auto">
      <div className="w-full mx-auto px-4 lg:px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-12">
          ...
          <div className="md:col-span-4 flex flex-col space-y-4">
            ...
            <p className="text-xs text-[#FFC800] font-semibold tracking-wider">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:col-span-8 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/services/loan-against-property" className="hover:text-[#FFC800] transition-colors">
                    Loan Against Property
                  </Link>
                </li>
                <li>
                  <Link href="/services/home-loan" className="hover:text-[#FFC800] transition-colors">
                    Home Loan
                  </Link>
                </li>
                <li>
                  <Link href="/services/personal-loan" className="hover:text-[#FFC800] transition-colors">
                    Personal Loan
                  </Link>
                </li>
                <li>
                  <Link href="/services/business-loans" className="hover:text-[#FFC800] transition-colors">
                    Business Loans
                  </Link>
                </li>
                <li>
                  <Link href="/services" className="text-[#FFC800] hover:underline font-semibold text-xs uppercase tracking-wider block mt-2">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/partners" className="hover:text-[#FFC800] transition-colors">
                    Lender Network
                  </Link>
                </li>
                <li>
                  <Link href="/enquiry" className="hover:text-[#FFC800] transition-colors">
                    Contact & Enquiry
                  </Link>
                </li>
              </ul>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs">
          ...
          <Link href="/privacy" className="hover:text-[#FFC800] transition-colors">Privacy Policy</Link>
            <span>&middot;</span>
            <Link href="/terms" className="hover:text-[#FFC800] transition-colors">Terms of Service</Link>
            <span>&middot;</span>
