...
export default function ServiceCard({ service }: { service: Service }) {
  return (
    <Link href={`/services/${service.slug}`} className="block group h-full">
      <div className="h-full flex flex-col bg-gray-900/50 backdrop-blur-xl border border-white/20 rounded-xl p-7 hover:border-[#F7C83C]/60 hover:shadow-[0_0_32px_4px_rgba(247,200,60,0.15)] hover:bg-gray-900/50 transition-all duration-500 ease-out group-hover:-translate-y-2">
        ...
        {/* Meta row */}
        <div className="flex items-center justify-between text-xs text-gray-500 pt-4 border-t border-white/20">
